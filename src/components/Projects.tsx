        ...
        >
          ...
          <motion.div {...fadeIn(0.3)} className="flex-1">
            ...
            <p className="text-gray-700 mb-4">
              Coindrift is a sleek, responsive cryptocurrency tracker built with <strong>React</strong>, <strong>Vite</strong>, and <strong>CSS</strong>. It offers a premium user experience with real-time coin data, visualizations, wishlist tracking, and a comparison tool — all in dark mode too!
            </p>
